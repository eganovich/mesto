...
export const editProfileModal = document.querySelector(
  ".modal_type_edit-profile"
);
export const addCardModal = document.querySelector(".modal_type_add-card");
export const editAvatarModal = document.querySelector(
  ".modal_type_edit-avatar"
);

//Объявляем элементы внутри модальных окон
//editProfileModal
export const editProfileFormName = editProfileModal.querySelector(
  ".modal__input_type_name"
);
export const editProfileFormAbout = editProfileModal.querySelector(
  ".modal__input_type_about"
);

//Объявляем кнопки, открывающие модальные окна
export const editProfileModalOpenButton = document.querySelector(
  ".edit-button"
);
